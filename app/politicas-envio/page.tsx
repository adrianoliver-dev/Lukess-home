    ...
    <LegalPageTemplate title="Políticas de Envío y Retiro" lastUpdated="2 de marzo de 2026">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700">
          <strong>Importante:</strong> Al recibir tu pedido, verifica que el producto y la talla coincidan con lo solicitado antes de que el courier se retire. Si detectas algún error, contáctanos de inmediato al <strong>+591 72643753</strong> para gestionar el cambio.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700">
          Si necesitas cambiar la dirección de entrega después de confirmar el pedido, contáctanos lo antes posible al WhatsApp <strong>72643753</strong>. Solo podemos modificar la dirección si el pedido no ha sido despachado aún.
        </p>
      </section>
    </LegalPageTemplate>
  )
