...
async function seed() {
  ...
  const categories = [
    { name: 'Camisas', organization_id: orgId },
    { name: 'Pantalones y Chinos', organization_id: orgId },
    { name: 'Poleras', organization_id: orgId },
    { name: 'Abrigos y Chaquetas', organization_id: orgId },
    { name: 'Accesorios y Calzado', organization_id: orgId },
    { name: 'Trajes Clásicos', organization_id: orgId }
  ]
  ...
  const products = [
    ...
    { sku: 'CAM-OXF-002', name: 'Camisa Oxford Premium', description: 'Corte tradicional y durabilidad excepcional. Un básico esencial del guardarropa masculino.', price: 380, cost: 180, category_id: cCamisas, brand: 'Lukess Signature', color: 'Blanco', sizes: ['S', 'M', 'L'], colors: ['Blanco'], is_featured: true },
    ...
    // Pantalones
    { sku: 'PAN-CHI-001', name: 'Pantalón Chino Slim Fit', description: 'Un ajuste entallado que proporciona un estilo moderno sin sacrificar comodidad.', price: 550, cost: 250, category_id: cPantalones, brand: 'Minimalist Sartorial', color: 'Negro', sizes: ['30', '32', '34', '36'], colors: ['Negro'], is_featured: true },
    ...
    // Poleras
    { sku: 'POL-PIM-001', name: 'Polera Pima Básica', description: '100% Algodón Pima peruano, el más suave del mercado, en un corte clásico (Regular Fit).', price: 250, cost: 110, category_id: cPoleras, brand: 'Pima Classics', color: 'Blanco', sizes: ['S', 'M', 'L', 'XL'], colors: ['Blanco'], is_featured: true },
    ...
    { sku: 'ZAP-SNE-001', name: 'Sneakers Urbanos Minimalistas', description: 'Cuero blanco de alta gama con suela antideslizante, combinan con traje o con jeans.', price: 950, cost: 450, category_id: cAccesorios, brand: 'Urban Tech', color: 'Blanco', sizes: ['40', '41', '42', '43'], colors: ['Blanco'], is_featured: true },
    ...
    // Added Trajes
    { sku: 'TRA-SUT-001', name: 'Traje Completo Tailored Fit', description: 'Conjunto de blazer y pantalón en lana tejida, para el ejecutivo moderno.', price: 3200, cost: 1500, category_id: cTrajes, brand: 'Lukess Signature', color: 'Azul marino', sizes: ['48', '50', '52'], colors: ['Azul marino'] },
