  ...
  return (
    <LegalPageTemplate title="Términos y Condiciones de Uso" lastUpdated="2 de marzo de 2026">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 mb-4">
          Puedes realizar compras directamente contactándonos al +591 72643753. Nuestro equipo verificará disponibilidad, confirmará precio y coordinará entrega o retiro en tienda.
        </p>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 mt-3">
          ...
          <li><strong>Transferencia Bancaria:</strong> Solicitá los datos al WhatsApp 72643753.</li>
