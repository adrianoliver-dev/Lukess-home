  ...
  return (
    <LegalPageTemplate title="Política de Privacidad y Protección de Datos" lastUpdated="2 de marzo de 2026">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 mt-4">
          Para ejercer cualquiera de estos derechos, contáctanos al <strong>+591 75516136</strong> (WhatsApp) o envía un correo a través de nuestro formulario de contacto.
        </p>
      </section>
